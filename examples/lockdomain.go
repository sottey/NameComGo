...
func LockDomainExample() {
    fmt.Println("Executing LockDomain() example...\n")
    ...
    // Make the call
    nameResponse := namecomgo.LockDomain(c, domainName)
    ...
    switch nameResponse.StatusCode {
    	case 200:
            ...
            namecomgo.Check("Error in LockDomain(): ", jsonErr)
